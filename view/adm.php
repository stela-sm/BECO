  ...
  <div class="col-12 table-header-col">
    <table class="table-header">
      <tr class="table-header-row">
        ...
        <th class="table-header-th">
          <a href="adm_new.html" class="add-link-icon"> <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-plus" width="26" height="26" viewBox="0 0 24 24" stroke-width="1.5" stroke="#4dbb69" fill="none" stroke-linecap="round" stroke-linejoin="round">
             <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
