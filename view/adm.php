...
<body>
    ...
    <div class="col-12 header-col">
        <span class="title-section">Administradores</span>
           <table class="adm-filters-table  col-5 ">
            <tr>
                <th>
                    Data
                </th>
                  ...
                  <td class="td-input ">
                    ...
                    <td class="td-input ">
                      ...
                      <select name="" class="input-search" id="">
                        ...
                        <option value="1">1 - Assistente</option>
                        <option value="2">2 - Deapartamento</option>
                        <option value="3">3 - Sitema</option>
  ...
  <div class="col-12 table-header-col">
    <table class="table-header">
      <tr class="table-header-row">
        ...
        <th class="table-header-th">
          <a href="user_new.html" class="add-link-icon"> <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user-plus" width="26" height="26" viewBox="0 0 24 24" stroke-width="1.5" stroke="#4dbb69" fill="none" stroke-linecap="round" stroke-linejoin="round">
             <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
